...
<html>
  <head>
    ...
    <title>Human Computation in Online Video Storytelling</title>
  ...
  <body>
    ...
    <div class="container light link_hover_red">
      ...
      <section class="project link_underline link_hover_red">
        <figure>
        ...
        <p>Download the <a href="/downloads/human_computation_in_online_video_storytelling.pdf" target="_blank">full dissertation</a></p>
      </section> <!-- /project -->
