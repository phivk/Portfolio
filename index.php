...
<html>
  ...
  <body>
    ...
    <div class="container">
      ...
      <section class="work">
        <figure class="speaking storytelling video">
          <a href="./projects/born-on-the-web.php">
            <img src="images/the-future.png" alt="Popathon" />
            <dl>
              <dt>Title</dt>
                <dd>Born on the web</dd>
              <dt>What</dt>
                <dd>Talk on web-native storytelling</dd>
            </dl>
          </a>
        </figure>
